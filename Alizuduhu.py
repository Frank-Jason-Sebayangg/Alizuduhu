...
# Coded By @Frank Jason
# https://www.facebook.com/100066074752186
# https://github.com/Frank-Jason-Sebayangg
...
def banner():
	clear()
	wel = '# WELCOME TO AREA TOOLS FRANK JASON SEBAYANG '
	...
	sol().print(fc)
	tap = me()
	tap.add_column('Author', style='red', justify='center')
	tap.add_column('Github', style='white', justify='center')
	tap.add_row('Frank Jason','https://github.com/frank-jason-sebayangg')
